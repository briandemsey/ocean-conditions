...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#0a1628]">
      {/* Top nav bar */}
      <nav className="bg-[#0d1f3c]/80 backdrop-blur-md border-b border-[#1e3a5f] px-4 sm:px-6 py-3 flex items-center justify-between sticky top-0 z-50">
        ...
        {!isHome && (
          <Link
            to="/"
            className="text-sm text-[#4a6a8a] hover:text-[#4a9eed] transition-colors"
          >
            Search Spots
          </Link>
        )}
      ...
      {/* Footer */}
      <footer className="border-t border-[#1e3a5f] px-4 sm:px-6 py-4 mt-auto">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-[#4a6a8a]">
